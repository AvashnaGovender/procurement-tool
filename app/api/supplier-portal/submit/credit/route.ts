...
/**
 * Session-validated proxy for the credit application submission.
...
export async function POST(request: NextRequest) {
  try {
    ...
    const internalResponse = await fetch(`${baseUrl}/api/suppliers/credit-application/submit`, {
      method: 'POST',
      body: formData,
    })
    ...
    console.error('Supplier portal submit/credit error:', error)
